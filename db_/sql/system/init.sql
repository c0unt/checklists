...
CREATE UNIQUE INDEX IF NOT EXISTS user_right ON ref_sys_users_x_rights USING btree (user_id, right_id);
...
ON CONFLICT (id)  DO nothing;
INSERT INTO data_log (id, dts, action, data, "user", token) VALUES ('61b15b5b-36cc-40d7-8410-9c69588b1013', '2017-12-17 08:55:59.409161+03', 'getIdentInfoQuery', '{"code":"1232","wer":"234234werewr"}', NULL, '00000000-0000-0000-0000-000000000000')ON CONFLICT (id)  DO nothing;
...
VALUES ('7a35c0b9-2d04-41e9-b670-e0b767247223', '6b007651-6cb9-4576-9d3c-dd90d02a6c93', 1, 'test check', 'do check', NULL, NULL, NULL, NULL, 0, '2018-01-03 21:35:37.550954+03', NULL)
ON CONFLICT (id)  DO nothing;
