...
CREATE TABLE data_checklist_content (
    id uuid DEFAULT uuid_generate_v4() NOT NULL,
    checklist_id uuid NOT NULL,  --reference to parent document
    check_order integer, -- used to order checks within check list
    name text,
    content text,
    comment text,
...
INSERT INTO ref_rpt_datasets (id, name, query, right_id, state, dts, object_id) VALUES ('5d1193da-80b6-41ee-b42b-2e0cbd4b083b', 'test data set', 'SELECT "id", "dts", "action", "data", "user", "token" FROM "data_log" WHERE "dts" >=TO_DATE($date1,''DD.MM.YYYY'') limit 2', NULL, 0, '2017-12-24 01:23:24.282143+03', NULL);
INSERT INTO ref_rpt_datasets (id, name, query, right_id, state, dts, object_id) VALUES ('f9f57185-d632-40bc-b9b6-f13cbefbb0ae', 'other', 'SELECT "id", "dts", "action", "data", "user", "token" FROM "data_log" WHERE "data" like $text1	 limit 2', NULL, 0, '2018-01-02 16:02:26.960152+03', NULL);
...
INSERT INTO ref_rpt_reports (id, name, right_id, state, dts, object_id) VALUES ('0415d6ef-4c66-40e8-972a-22d570db0c76', 'test report2', NULL, 0, '2017-12-24 01:27:42.235888+03', NULL);
...
INSERT INTO ref_rpt_views (id, name, path, maket, report_id, right_id, generator, state, dts, object_id) VALUES ('982a3edb-5d09-4241-9842-f065d94dae8b', 'test view', 'test', NULL, '0415d6ef-4c66-40e8-972a-22d570db0c76', '103c5141-ae66-490f-9bce-b485bed10027', 'html', 0, '2017-12-24 01:30:58.038241+03', NULL);
...
INSERT INTO ref_sys_menuitems (id, name, state, path, icon, right_id, application_id) VALUES ('5c4e4612-15ea-423d-a365-2b7287bd47c0', 'Checklists', 0, '/checklists', NULL, '103c5141-ae66-490f-9bce-b485bed10027', '6eb63ba3-5c35-494d-af56-aa1526aa0964');
INSERT INTO ref_sys_menuitems (id, name, state, path, icon, right_id, application_id) VALUES ('11645be1-ddf5-49f4-b96c-da3504433903', 'Users', 0, '/users', NULL, '103c5141-ae66-490f-9bce-b485bed10027', '6eb63ba3-5c35-494d-af56-aa1526aa0964');
INSERT INTO ref_sys_menuitems (id, name, state, path, icon, right_id, application_id) VALUES ('e1e5b3b7-957f-44fc-ab63-280f60554e2b', 'Reports', 0, '/reports', NULL, '103c5141-ae66-490f-9bce-b485bed10027', '6eb63ba3-5c35-494d-af56-aa1526aa0964');
